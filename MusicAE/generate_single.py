...
save_path = 'params/music_attr_vae_singlevae_8.pt_190.pt'
...
for cnt in range(0, 5):
    ...
    pm = magenta_decode_midi(notes=d_t, file_path="single_midi/origin_"+ str(idx) +".mid")  #!
    ...
    pm = magenta_decode_midi(notes=clean_output(out), file_path="single_midi/reconstruction_"+ str(idx) +".mid")
